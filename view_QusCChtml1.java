 ...
 * @author Gaurav
 */
public class view_QusCChtml1 extends javax.swing.JFrame {
...
String timecheck=null;
   ...
   public static List<user> BindList()
   {
       ...
       String sql="select * from difficulthtml";
...
timer1.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_QusCChtml1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new view_QusCChtml1().setVisible(true);
            }
        });
    }
