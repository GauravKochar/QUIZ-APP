 ...
 * @author Gaurav
 */
public class view_QusC extends javax.swing.JFrame {
...
timer1.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_QusC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
