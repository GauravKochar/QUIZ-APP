 ...
 * @author Gaurav
 */
public class Add_Qushtml extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      try
      {
        ...
        String sql="insert into html values('"+que+"','"+a+"','"+b+"','"+c+"','"+d+"','"+ans+"','"+id+"')";
        ...
        JOptionPane.showMessageDialog(null,"ADD SUCCESSFULLY");
         ...
         {
              String sqll="insert into difficulthtml values('"+que+"','"+a+"','"+b+"','"+c+"','"+d+"','"+ans+"','"+id+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Qushtml.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
