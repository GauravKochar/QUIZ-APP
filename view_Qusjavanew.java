 ...
 * @author Gaurav
 */
public class view_Qusjavanew extends javax.swing.JFrame {

   Connection con=null;
  public static  PreparedStatement pst=null;
public static    ResultSet rs=null;
String timecheck=null;
   int pos=0,sop=0,pi=0,rt=0;
   Timer timer,timer1;
   int attempt=0,right=0,wrong=0;
   int count;
   
    public view_Qusjavanew() {
...
timer1.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_Qusjavanew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new view_Qusjavanew().setVisible(true);
            }
        });
    }
