 ...
 * @author Gaurav
 */
public class Add_Qusphp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Add Qusestions Here..");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      try
      {
       ...
       if(mode.equals("Easy"))
        ...
        String sql="insert into php values('"+que+"','"+a+"','"+b+"','"+c+"','"+d+"','"+ans+"','"+id+"')";
        PreparedStatement pst=Con.prepareStatement(sql);
        pst.execute();
         }
         else if(mode.equals("Difficult"))
         {
              String sqll="insert into difficultphp values('"+que+"','"+a+"','"+b+"','"+c+"','"+d+"','"+ans+"','"+id+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Qusphp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
